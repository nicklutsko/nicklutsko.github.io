...
$$
\tau \sim \frac{\espilon RH}{\Gamma}\int_T_t^T {e_{sat}}(T'){T'}dT'
$$ 
where $\epsilon$ is the ratio of the molecular masses or water and air, $RH$ is the relative humidity and $e_{sat}$ is the water vapor saturation pressure.
