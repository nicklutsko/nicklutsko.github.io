...
<p>I think it’s fair to divide the arguments for and against each option into those that focus on the more abstracts merits of each option and those that have to do with actually implementing either system. Let’s start with the abstract arguments.</p>
