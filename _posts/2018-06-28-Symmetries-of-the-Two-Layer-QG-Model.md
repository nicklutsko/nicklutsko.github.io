...
<p>An important feature of the model’s climate is the fact that the zonal-mean PV gradient in the upper layer is larger in magnitude than the PV gradient in the lower layer:
$$
...
$$
and then switch the layers, i.e., make the co-ordinate transform $z → -z$.</p>
