...
<p>Surprisingly, when doing this kind of decomposition for summer stationary waves, the direct and indirect effects seem to produce the opposite responses, so that the net effect is the residual of a "tug of war":</p>
