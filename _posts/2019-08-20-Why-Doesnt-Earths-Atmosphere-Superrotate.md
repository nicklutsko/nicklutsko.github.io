...
<p>These eddy fluxes are balanced by fluctuations in the zonal-mean flow, which are really just the seasonal cycle of the HC. Here's what the divergence of the angular transport by the zonal-mean HC looks like over the course of the year (top panel):</p> 
